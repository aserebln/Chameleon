...
static EFI_CHAR16 const FIRMWARE_VENDOR[] = {'C','h','a','m','e','l','e','o','n','_','2','.','0','_','A','s','e','r','e','B','L','N', 0};
static EFI_UINT32 const FIRMWARE_REVISION = 119; /* FIXME: Find a constant for this. */
